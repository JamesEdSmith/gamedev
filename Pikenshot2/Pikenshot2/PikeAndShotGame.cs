...
namespace PikeAndShot
{
    public class PikeAndShotGame : Microsoft.Xna.Framework.Game
    {
        ...
        public const int SCREENWIDTH = 1024;//1600;//1024; //1280//1024//1400
        public const int SCREENHEIGHT = 768;//1024;//768;//720//576//788
        ...
        protected override void LoadContent()
        {
            ...
            TEST = Content.Load<Texture2D>(@"adam");
            //TEST = Content.Load<Texture2D>(@"slide");
