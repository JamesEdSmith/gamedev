...
namespace MoleHillMountain
{
    public class PikeAndShotGame : Microsoft.Xna.Framework.Game
    {
        ...
        public const int SMALL_WIDTH = 256;
        public const int SMALL_HEIGHT = 192;
        ...
        public static Texture2D PALETTE_LIGHT;
        ...
        public static SoundEffect GAMEBOY_SOUND;
        ...
        public Color screenColorShader1;
        ...
        public PikeAndShotGame()
        {
            ...
            screenColorShader2 = new Color(5, 186, 155, 0);
        }
        ...
        protected override void LoadContent()
        {
            ...
            effect3.Parameters["video_size"].SetValue(new Vector2(SMALL_WIDTH, SMALL_HEIGHT));
            effect3.Parameters["texture_size"].SetValue(new Vector2(SMALL_WIDTH, SMALL_HEIGHT));
            ...
            GAMEBOY_SOUND = Content.Load<SoundEffect>(@"gameboy_start_up");
