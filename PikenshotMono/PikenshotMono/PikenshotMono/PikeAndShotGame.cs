    ...
    public class PikeAndShotGame : Microsoft.Xna.Framework.Game
    {
        ...
        public PikeAndShotGame()
        {
            ...
            if (!DEBUG)
            {
                ...
                float _ScreenWidth = System.Windows.Forms.Screen.PrimaryScreen.Bounds.Width;
        ...
        internal void fullScreen()
        {
            ...
            else
            {
                ...
                //make it full screen... (borderless if you want to is an option as well)
                this.Window.Position = new Point((int)(_ScreenWidth/(float)SCREENWIDTH/2f), (int)(_ScreenHeight / (float)SCREENHEIGHT / 2f));
